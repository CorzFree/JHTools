...
/**
 ...
 @param payType 使用的支付类型（1：余额  51：支付宝  52：微信）
 */
...
/**
 ...
 @param money 金额
 @param myServer 区服id
 @param ext 扩展参数(可为nil)
 */
- (void)showPayControllerViewWithOrder:(NSString*)order info:(NSString*)info money:(NSString*)money server:(NSString*)myServer ext:(NSString *)ext;
...
/**
 ...
 @param type "yz":开通悠钻；"user"/nil : 用户中心
 */
...
/**
 * 支付包原生跳转回调（可用application: openURL:替代）
 */
