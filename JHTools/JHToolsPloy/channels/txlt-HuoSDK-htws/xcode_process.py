...
def post_process(self, project, infoPlist, sdkparams):
    ...
    project.preprocessor_macros(["HAVE_CONFIG_H", "CC_TARGET_OS_IPHONE", "$(inherited)"])
    ...
    self.addBundleURLType(CFBundleTypeRole="Editor", CFBundleURLName="huosdk", CFBundleURLSchemes=["h17aiyouxi.com602532"])
