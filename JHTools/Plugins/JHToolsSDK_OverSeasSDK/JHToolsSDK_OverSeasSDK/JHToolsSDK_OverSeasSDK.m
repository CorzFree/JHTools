//
//  JHToolsSDK_OverSeasSDK.m
//  JHToolsSDK_OverSeasSDK
//
//  Created by Star on 2018/3/17.
//  Copyright © 2018年 Star. All rights reserved.
//

#import "JHToolsSDK_OverSeasSDK.h"
#import "OverseasSDK/OverseasSDK.h"
#import <UIKit/UIKit.h>
#import "HNPloyProgressHUD.h"
#import "JHToolsUtils.h"

@interface JHToolsSDK_OverSeasSDK()<WanManagerDelegate>
...
@implementation JHToolsSDK_OverSeasSDK
...
-(void)submitUserInfo:(JHToolsUserExtraData *)data{
    [[WanManager shareInstance] uploadUid:self.channelUid serverID:[NSString stringWithFormat:@"%d", data.serverID] serverName:data.serverName roleName:data.roleName roleLevel:data.roleLevel];
}
