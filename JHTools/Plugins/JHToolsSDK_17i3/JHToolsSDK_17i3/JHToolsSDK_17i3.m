...
#import "JHToolsSDK_17i3.h"
#import "YYSDK.h"
#import "JHToolsUtils.h"
#import "HNPloyProgressHUD.h"

@interface JHToolsSDK_17i3()<YYSDKDelegate>

@property (nonatomic, copy) NSString * uid;

@end

@implementation JHToolsSDK_17i3
...
-(void) pay:(JHToolsProductInfo*) profuctInfo{
    [[JHToolsSDK sharedInstance].proxy getOrderWith:profuctInfo responseHandler:^(NSURLResponse *response, id data, NSError *connectionError) {
        ...
        if (code != nil && [code isEqualToString:@"1"]) {
            ...
            [[YYSDK sharedInstance] showPayControllerViewWithOrder:orderNo info:[JHToolsUtils stringValue:profuctInfo.productDesc] money:[profuctInfo.price stringValue] server:[JHToolsUtils stringValue:profuctInfo.serverId] ext:orderNo];
        }else{
